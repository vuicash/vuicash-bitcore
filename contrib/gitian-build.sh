...
VERSION=
commit=false
url=https://github.com/vuicash/qtum-bitcore
...
-u|--url	Specify the URL of the repository. Default is https://github.com/vuicash/qtum-bitcore
...
then
    ...
    git clone https://github.com/vuicash/qtum-bitcore-detached-sigs.git
